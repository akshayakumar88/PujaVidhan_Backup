    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                Edit Item <a href="{{ route('items.index') }}" class="label label-primary pull-right">Back</a>
            </div>
            <div class="panel-body">
                <form action="{{ route('items.update', $item->id) }}" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="item_sub_cat" id="item_sub_cat" class="form-control" value="{{ $item->item_sub_cat }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Category Id</label>
                        <div class="col-sm-10">
                            <input type="number" name="catagory_id" id="catagory_id" class="form-control" value="{{ $item->catagory_id }}">
                        </div>
                    </div>
                    <div class="form-group">
